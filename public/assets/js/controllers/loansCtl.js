					...
					clients.get().$promise.then(function(clientsData) {
						...
						loans.get().$promise.then(function(loansData) {
							...
							staff.get().$promise.then(function(staffData) {
									...
									//staff
									$scope.staff.find = function(staffID) {
										var s = $scope.staff.filter(function(staffMember) {
									...
									$scope.loans.forEach(function(loan) {
										...
										var staffMember = $scope.staff.find(loan.staffID);
										...
										if (staffMember) loan.staffName = staffMember.staffFirstName + " " + staffMember.staffLastName;
